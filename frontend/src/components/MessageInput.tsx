  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          type="text"
          className="flex-1 bg-gray-700 placeholder-gray-400 text-white rounded-lg px-4 py-2"
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2 transition-colors flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isUploading ? (
